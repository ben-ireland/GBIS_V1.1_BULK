...
OrigData = dir('/home/jl20461/GBIS_V1.1_BULK/OriginalData/*WithLast.mat');
Masks = dir('/home/jl20461/GBIS_V1.1_BULK/Buffers/*WithLast.mat');
SlidingWindows = dir('/home/jl20461/GBIS_V1.1_BULK/SignalLocation/WithLastStep2/*_SlidingWindow_Clustering_50_7_Box_20.mat');
ICAs = dir(['/home/jl20461/GBIS_V1.1_BULK/ICA/*',RunName,'Comparison.mat']);
OtsuBBs = dir(['/home/jl20461/GBIS_V1.1_BULK/Bounding_Boxes/*_BoundingBox_2_MaskVolc_ICA_',RunName,'.mat']);
OtsuMasks = dir(['/home/jl20461/GBIS_V1.1_BULK/Bounding_Boxes/*_LargestMask_2_MaskVolc_ICA_',RunName,'.mat']);

for i = 1:length(ICAs)
    disp(num2str(i))

    % Define filepaths
    OriginalData = strcat(OrigData(5).folder,'/',OrigData(5).name);
    MaskData = strcat(Masks(5).folder,'/',Masks(5).name);
    SlidingWindow = strcat(SlidingWindows(5).folder,'/',SlidingWindows(5).name);
    ...
    VolcName = extractBefore(OrigData(5).name,'WithLast');
    ...
    DMRData = dir(['/home/jl20461/GBIS_V1.1_BULK/ICA_DMRs/',VolcName,RunName,'*DS.mat']);
    ...
    % PDF data for strength and extent
    for k = 3:4
    ...
    saveas(f,['/home/jl20461/GBIS_V1.1_BULK/PreProcessingFigs/New3/',VolcName,'_',RunName,'_PreProcessingTradeoff.png']);
    ...
    save(['/home/jl20461/GBIS_V1.1_BULK/PreProcessingFigs/New3/',VolcName,'_',RunName,'_PreProcessingTradeoff.mat']...
