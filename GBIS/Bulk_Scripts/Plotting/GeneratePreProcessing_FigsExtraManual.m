...
RunName = 'ICA_Buffer_WithLast_V4Manual'; % For inversion results
...
for i = 1:length(OrigData)
    if contains(OrigData(i).name,'nabro_006') || contains(OrigData(i).name,'dabbahu') 
        n = n+1;
...
for i = 1:length(ICAs)
    ...
    saveas(f,['/home/jl20461/GBIS_V1.1_BULK/PreProcessingFigs/',VolcName,'_',RunName,'_PreProcessing.svg']);
    saveas(f,['/home/jl20461/GBIS_V1.1_BULK/PreProcessingFigs/',VolcName,'_',RunName,'_PreProcessing.png']);
    ...
    save(['/home/jl20461/GBIS_V1.1_BULK/PreProcessingFigs/',VolcName,'_',RunName,'_PreProcessing.mat']...
        ,'OrigLastStep','OrigLon','OrigLat','MaskLastStep','ICA_Reconstructed','SlideWind',...
        'DMR','Conv','PDF');
