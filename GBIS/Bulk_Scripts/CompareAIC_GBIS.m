...
DeltaAICWRSS2 = nObs*(log(OtherWRSS2/MogiWRSS2)) + (2*nParaOther - 2*nParaMogi);
DeltaAICRSS = nObs*(log(OtherRSS/MogiRSS)) + (2*nParaOther - 2*nParaMogi);
DeltaAICRMSE = nObs*(log(OtherRMSE/MogiRMSE)) + (2*nParaOther - 2*nParaMogi);
