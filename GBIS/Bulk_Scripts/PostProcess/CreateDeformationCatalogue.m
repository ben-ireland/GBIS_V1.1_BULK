function FullTable = CreateDeformationCatalogue(OutputFilePath,VolcName, NumFrames, SignalLocationGBIS ,Options,DeltaAIC,DeltaAICUnw,DeltaBIC,DeltaBICUnw,BestModel,AspectRatio)
