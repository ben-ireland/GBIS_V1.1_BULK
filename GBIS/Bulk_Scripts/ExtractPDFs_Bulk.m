...
Files = dir('/home/jl20461/GBIS_V1.1_BULK/Inversion_Results/*NoICA_Buffer_NoLast_V4Manual/**/invert_1_M*.mat');
...
for k = 1:length(Files)
    ...
    RMS = ExtractFullResRMSOne(OutputFilePath);
...
writetable(T,'RMSE_NoICA_Buffer_NoLastV4ManualV2.csv');