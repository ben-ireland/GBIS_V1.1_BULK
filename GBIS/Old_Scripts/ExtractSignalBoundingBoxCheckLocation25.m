function [BoundingBox, Image, OtsuFigure, SignalLocation, largest_component_mask] = ExtractSignalBoundingBoxCheckLocation25(BB_Shape, LastStep, numlevels, VolcName, SpatialRes, lon, lat, Location, Options)
