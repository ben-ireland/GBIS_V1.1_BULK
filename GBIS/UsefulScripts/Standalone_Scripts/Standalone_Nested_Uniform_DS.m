function [loadedData, Filename, Filename_Raw, nObs_SS, nObs_Raw, BoundingBox, NewSS_Factor, NewSS_FactorF] = Standalone_Nested_Uniform_DS(Phase,lon,lat,AOI,head,incidence,VolcName,Options)
    ...
    for k = 1:length(SS)
        ...
        if k==1
            Filename_Raw = char(strcat(pwd,'/InputData/',VolcanoName,'_',SS_Style,'_',Options.RunID,'_.mat'))
        ...
        elseif k==2
            Filename = char(strcat(pwd,'/InputData/',VolcanoName,'_',SS_Style,'_',Options.RunID,'_.mat'))
