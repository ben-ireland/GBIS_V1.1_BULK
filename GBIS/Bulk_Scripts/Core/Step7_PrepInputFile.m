    ...
    if Options.Bounds ==1
        if Options.SourceType==1 || Options.PennyComparison ==1
            ...
            if Options.EstimateDepthBounds ==1
                startBounds(3) = Options.NewDepthLims(1);
                lowerBounds(3) = Options.NewDepthLims(2);
                upperBounds(3) = Options.NewDepthLims(3);
            end
        ...
        if Options.SourceType==2 || Options.PennyComparison ==1 || ((matches(Options.OtherSourceType,'P') || matches(Options.OtherSourceType,'C') || matches(Options.OtherSourceType,'V')) && Options.OtherSource ==1)
            ...
            if Options.EstimateDepthBounds ==1
                startBoundsPen(3) = Options.NewDepthLims(1);
                lowerBoundsPen(3) = Options.NewDepthLims(2);
                upperBoundsPen(3) = Options.NewDepthLims(3);
            end
        ...
        if Options.SillComparison==1 || (matches(Options.OtherSourceType,'S') && Options.OtherSource ==1)
            ...
            if Options.EstimateDepthBounds ==1
                startBoundsSill(3) = Options.NewDepthLims(1);
                lowerBoundsSill(3) = Options.NewDepthLims(2);
                upperBoundsSill(3) = Options.NewDepthLims(3);
            end
        ...
        if Options.YangComparison==1 || ((matches(Options.OtherSourceType,'Y') || matches(Options.OtherSourceType,'E') || matches(Options.OtherSourceType,'R')) && Options.OtherSource ==1)
            ...
            if Options.YangType ==1
                if Options.EstimateDepthBounds ==1
                    startBoundsYang(3) = Options.NewDepthLims(1);
                    lowerBoundsYang(3) = Options.NewDepthLims(2);
                    upperBoundsYang(3) = Options.NewDepthLims(3);
                end
            ...
            elseif Options.YangType ==2
                if Options.EstimateDepthBounds ==1
                    startBoundsYang(7) = Options.NewDepthLims(1);
                    lowerBoundsYang(7) = Options.NewDepthLims(2);
                    upperBoundsYang(7) = Options.NewDepthLims(3);
                end
        ...
        if Options.DykeComparison==1 || (matches(Options.OtherSourceType,'D') && Options.OtherSource ==1)
            ...
            if Options.EstimateDepthBounds ==1
                startBoundsDyke(3) = Options.NewDepthLims(1);
                lowerBoundsDyke(3) = Options.NewDepthLims(2);
                upperBoundsDyke(3) = Options.NewDepthLims(3);
            end
        ...
        if Options.CDMComparison==1 || ((matches(Options.OtherSourceType,'A')||...
            ...
            if ismember(1,Options.CDMGeometry) || (matches(Options.OtherSourceType,'A') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDM(3) = Options.NewDepthLims(1);
                    lowerBoundsCDM(3) = Options.NewDepthLims(2);
                    upperBoundsCDM(3) = Options.NewDepthLims(3);
                end
            ...
            if ismember(2,Options.CDMGeometry) || (matches(Options.OtherSourceType,'B') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDMB(3) = Options.NewDepthLims(1);
                    lowerBoundsCDMB(3) = Options.NewDepthLims(2);
                    upperBoundsCDMB(3) = Options.NewDepthLims(3);
                end
            ...
            if ismember(3,Options.CDMGeometry) || (matches(Options.OtherSourceType,'G') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDMG(3) = Options.NewDepthLims(1);
                    lowerBoundsCDMG(3) = Options.NewDepthLims(2);
                    upperBoundsCDMG(3) = Options.NewDepthLims(3);
                end
            ...
            if ismember(4,Options.CDMGeometry) || (matches(Options.OtherSourceType,'I') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDMI(3) = Options.NewDepthLims(1);
                    lowerBoundsCDMI(3) = Options.NewDepthLims(2);
                    upperBoundsCDMI(3) = Options.NewDepthLims(3);
                end
            ...
            if ismember(5,Options.CDMGeometry) || (matches(Options.OtherSourceType,'J') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDMJ(3) = Options.NewDepthLims(1);
                    lowerBoundsCDMJ(3) = Options.NewDepthLims(2);
                    upperBoundsCDMJ(3) = Options.NewDepthLims(3);
                end
            ...
            if ismember(6,Options.CDMGeometry) || (matches(Options.OtherSourceType,'K') && Options.OtherSource ==1)
                ...
                if Options.EstimateDepthBounds ==1
                    startBoundsCDMK(3) = Options.NewDepthLims(1);
                    lowerBoundsCDMK(3) = Options.NewDepthLims(2);
                    upperBoundsCDMK(3) = Options.NewDepthLims(3);
                end
